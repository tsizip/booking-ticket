...
export default memo(function Footer(props) {
     let logoCumRap = props.logoCumRap

     

     // console.log('logo', logoCumRap)
     return (
          <footer className="p-6 bg-slate-800 text-gray-300 dark:bg-gray-800 dark:text-gray-100">
               <div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4">
                    <div className="flex flex-col space-y-4">
                         <h2 className="font-medium text-white font-bold">Getting started</h2>
                    ...
                    <div className="flex flex-col space-y-4">
                         <h2 className="font-medium text-white font-bold">Core Concepts</h2>
                         <div className="flex flex-col space-y-2 text-sm dark:text-gray-400">
                    ...
                    <div className="flex flex-col space-y-4">
                         <h2 className="font-medium text-white font-bold">Customization</h2>
                         <div className="flex flex-col space-y-2 text-sm dark:text-gray-400">
                              <div className='grid grid-cols-3 ' >
                                   {logoCumRap.map((item, index) => {
                                        return <img key={index} alt='123' width={50} src={item.logo} />
                                   })}
                              </div>
                    ...
                    <div className="flex flex-col space-y-4">
                         <h2 className="font-medium text-white font-bold">Community</h2>
                         <div className="flex flex-col space-y-2 text-sm dark:text-gray-400">
