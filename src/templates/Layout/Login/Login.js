...
import { UserManagementAction } from '../../../redux/actions/UserManagementAction/UserManagementAction';
...
export default function Login() {
     ...
     // const getItem = ()=>{
     //      localStorage.setItem('dataLogin', 'login data')
     // }
     const formik = useFormik({
          ...
          onSubmit: async values => {
               ...
               await dispatch(UserManagementAction(values))
               let idDatVe = await localStorage.getItem('idDatVe')
               if(idDatVe){
                    navi(`${idDatVe}`)
               } else {
                    navi('/')
     ...
     return (
          <Fragment>
               <form onSubmit={formik.handleSubmit} className="lg:flex">
                              ...
                              <div className="mt-12">
                                   <div>
                                        <div>
                                             ...
                                             <input onChange={formik.handleChange} name='taiKhoan' className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Nhập tài khoản" />
                                        </div>
                                        <div className="mt-8">
