...
export default function Modal(props) {
     let statusModal = props.statusModal
     let setStatusModal = props.setStatusModal
     console.log('KK')
     let cls = ['relative', 'z-10', statusModal ? 'open' : 'close']
     console.log(_.join(cls, ' '))
     return (
          <div className={_.join(cls,' ')} aria-labelledby="modal-title" role="dialog" aria-modal="true">
